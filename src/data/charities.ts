...
export const charities: Charity[] = [
  ...
  },
  {
    ...
    fullDescription:
      'Taimaka treats childhood acute malnutrition in northeastern Nigeria. They have a high cost-effectiveness estimate, but the evidence is less robust than our Top Charities, making them a higher-risk, higher-reward option. They can be a good pick for those who place a high value on extending lives.',
    costPerWellby: 15.15,
    confidenceScore: 3,
